import { reducer as membershipReducer } from './reducer';
import {
    setHistory,
    setMembershipTypes,
    failedMembership,
...
test('It should set membership data', () => {
    const membership = {
    ...
    const state = membershipReducer({}, action);
...
test('It should set membership types data', () => {
...
test('It should set membership selected data', () => {
    const membership = {
        id: '5ccb1dd4-9afd-4f0e-826b-5acd1f2aec4f',
        name: 'Test',
        type_membership_id: '4c74deca-d528-11eb-b8bc-0242ac130009',
...
test('It should set modules membership', () => {
    const modules = [
        {
            id: '1',
...
test('It should failed membership', () => {
    ...
    const action = failedMembership('Fallo en el servidor.');
    const state = membershipReducer(initialState, action);
    expect(state).toEqual({
