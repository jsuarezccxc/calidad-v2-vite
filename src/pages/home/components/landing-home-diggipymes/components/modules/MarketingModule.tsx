...
import marketingModule from '@assets/images/landing/marketing-page.svg';
                    ...
                    <div className="header-module">
                        <h1
                            id={generateId({
                                ...
                                submodule: 'marketing-module-title',
                                action: ActionElementType.INFO,
                                elementType: ElementType.TXT,
                            })}
                            className="header-module__title header-module__nowrapline"
                        >
                            ¿Es un camello convencer a sus clientes?
                        </h1>
                        <h2
                            id={generateId({
                                module: ModuleApp.LANDING,
                                submodule: 'marketing-module-subtitle',
                                action: ActionElementType.INFO,
                                elementType: ElementType.TXT,
                            })}
                        ...
                        <p
                            id={generateId({
                                module: ModuleApp.LANDING,
                                submodule: 'marketing-module-description',
                                action: ActionElementType.INFO,
                                elementType: ElementType.TXT,
                            })}
                            className="header-module__description"
                        >
                            Con el CRM comprenda las necesidades de sus clientes
                        </p>
                    </div>

                    <div className="body-module">
                        <img src={marketingModule} alt="marketing-module" />
                        <Button
                            id={generateId({
                                module: ModuleApp.LANDING,
                                submodule: 'marketing-module',
