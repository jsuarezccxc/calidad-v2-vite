...
import { CONTACT_NAME_VALIDATION_REGEX, DATA_TYPE, DIGGIPYMES, FormDataIndexes, IFormData, INITIAL_VALUES, INPUT_NAMES, PHONE_VALIDATION_REGEX, VALIDATE_NUMBER_ZERO } from '..';
